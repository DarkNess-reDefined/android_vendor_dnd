...
ALARM_PATH := vendor/dnd/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/dnd/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/dnd/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/dnd/prebuilt/common/media/audio/ui
