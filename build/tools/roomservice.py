...
custom_local_manifest = ".repo/local_manifests/dnd_manifest.xml"
custom_default_revision = "o"
custom_dependencies = "dnd.dependencies"
org_manifest = "TeamDarkness-Devices"  # leave empty if org is provided in manifest
org_display = "TeamDarkness-Devices"  # needed for displaying
